<html>
  ...
  <body>
      ...
      <input value="espuelas"name="producto" type="hidden"/>
      ...
      <input value="casco"name="producto" type="hidden"/>
      <input type="text" name="cantidad">
      <input type="submit" value="añadir" >
      </div>
      </form>
      ...
      <img id="photo3" src="img/guante-roeckl-wisbech-invierno-par.jpg"/>
       <input value="guantes"name="producto" type="hidden"/>
      <input type="text" name="cantidad">
      <input type="submit" value="añadir" >
      </div>
      </form>
      ...
      <img id="photo4" src="img/Pantalon-equitacion-140-Ninos-Fouganza-marron.jpg"/>
       <input value="pantalon"name="producto" type="hidden"/>
      <input type="text" name="cantidad">
      <input type="submit" value="añadir" >
      </div>
      </form>
